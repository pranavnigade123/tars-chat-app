        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 max-w-md">
            <h2 className="text-4xl font-bold text-white leading-tight">
              Start your journey with seamless messaging
            </h2>
            <p className="text-lg text-blue-100">
              Create your account and join thousands of users already chatting on Tars Chat.
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-start sm:items-center justify-center p-4 sm:p-6 lg:p-8 overflow-y-auto">
        <div className="w-full max-w-md py-4 sm:py-0">
          ...
          <div className="lg:hidden mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-gray-600">Start chatting in seconds</p>
          </div>
