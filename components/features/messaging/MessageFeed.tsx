...
export function MessageFeed({ conversationId, currentUserId, scrollToBottomRef }: MessageFeedProps) {
  ...
  return (
    <div 
      ...
      className="relative flex-1 overflow-y-auto p-4 space-y-1 bg-gradient-to-b from-gray-50 to-white dark:from-[#121212] dark:to-[#1e1e1e]"
    >
          ...
          >
            ...
            >
              {showName && !isCurrentUser && (
                <span className="text-xs font-medium text-gray-700 dark:text-gray-400 px-3 mb-1">
              ...
              <div className="relative group/message">
                ...
                {isUnread && (
                  <div className="absolute -top-2 -left-2 bg-blue-600 dark:bg-blue-500 text-white text-xs font-bold px-2 py-0.5 rounded-full shadow-md z-10">
                    NEW
                  </div>
                )}
                ...
                <div
                  className={cn(
                    ...
                    isCurrentUser
                      ...
                      : isUnread
                      ? "bg-blue-50 dark:bg-[#2a2a2a] text-gray-900 dark:text-gray-100 border-2 border-blue-400 dark:border-blue-600 ring-2 ring-blue-100 dark:ring-gray-700"
                      : "bg-white dark:bg-[#242424] text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-[#2d2d2d]",
